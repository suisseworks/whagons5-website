const baseTranslations = {
  es: {
    ...
    demoCompanyLabel: 'Hotel o empresa',
    demoCompanyPlaceholder: 'Nombre del hotel o empresa',
    ...
    demoNote: 'Te contactamos en un día hábil.',
  ...
  en: {
    ...
    demoCompanyLabel: 'Hotel or company',
    demoCompanyPlaceholder: 'Hotel or company name',
    ...
    demoTeamSizeLabel: 'Operations team size',
