...
export function demoSegmentName(language) {
  if (language === 'es') return DEMO_SEGMENT_NAMES.es;
  if (language === 'en') return DEMO_SEGMENT_NAMES.en;
  throw new Error('Unsupported demo language');
}
