  ...
  es: [
    {
      ...
      desc: 'Un copiloto que busca, analiza y recomienda acciones con contexto real de tu operación. Toma decisiones basadas en datos, no en suposiciones.',
      features: [
    ...
    },
    {
      ...
      desc: 'Crea planes de trabajo, asigna tareas recurrentes, gestiona horarios y controla costos operativos. Todo trazable, todo medible.',
      features: [
    ...
    },
    {
      ...
      desc: 'Captura datos en campo con formularios digitales, firmas electrónicas y flujos de aprobación. Compatible con escaneo QR, códigos de barra y geolocalización GPS.',
      features: [
  ...
  en: [
    {
      ...
      desc: 'A strategic copilot that searches, analyzes, and recommends actions with real context from your operation. Make decisions based on data, not assumptions.',
      features: [
    ...
    },
    {
      ...
      desc: 'Create work plans, assign recurring tasks, manage schedules, and control operational costs. Fully traceable, fully measurable.',
      features: [
    ...
    },
    {
      ...
      desc: 'Capture field data with digital forms, electronic signatures, and approval workflows. Compatible with QR scanning, barcodes, and GPS geolocation.',
      features: [
